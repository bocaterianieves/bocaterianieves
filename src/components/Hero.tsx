  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src={heroBg} 
          alt="Deliciosos bocadillos artesanales" 
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-3xl mx-auto animate-fade-in">
          ...
          <a 
            href="#pedido" 
            className="inline-flex items-center gap-2 bg-gradient-warm text-primary-foreground px-8 py-4 rounded-xl font-semibold text-lg shadow-warm hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
          >
            Hacer Pedido
