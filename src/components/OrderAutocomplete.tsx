    ...
    <div className="relative">
      <div className="relative">
        <textarea
          ...
          className={cn(
            "flex min-h-[80px] w-full rounded-md border border-input bg-muted/50 px-3 py-2 pr-12 text-base ring-offset-background placeholder:text-muted-foreground cursor-default md:text-sm",
            className
          )}
          rows={3}
        />
